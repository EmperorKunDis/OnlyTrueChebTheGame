...
public class CollisionChecker {
    ...
    public void checkTile(Entity entity) {
        ...
        int entityBotWY = entity.worldY + entity.solidArea.y + entity.solidArea.height;
        ...
        int entityBotRow = entityBotWY/gp.tileSize;
        ...
        switch(entity.direction) {
            case "up":
                ...
                break;
            case "down":
                entityBotRow = (entityBotWY + entity.speed) / gp.tileSize;
